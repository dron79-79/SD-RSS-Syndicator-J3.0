...
$save_file          = JFactory::getApplication()->input->get('save_img',0,'int');
$leftTextPosition   = JFactory::getApplication()->input->get('leftTextPosition', 5,'int');
$rightTextPosition  = JFactory::getApplication()->input->get('rightTextPosition', 29,'int');
$barPosition        = JFactory::getApplication()->input->get('barPosition', 25,'int');

$leftText           = JFactory::getApplication()->input->get('leftText', 'RSS');
$rightText          = JFactory::getApplication()->input->get('rightText', 'VALID');
$leftTextColor      = JFactory::getApplication()->input->get('leftTextColor', 'ffffff');
$rightTextColor     = JFactory::getApplication()->input->get('rightTextColor', 'ffffff');
$outerBorder        = JFactory::getApplication()->input->get('outerBorder', '666666');
$innerBorder        = JFactory::getApplication()->input->get('innerBorder', 'ffffff');
$leftFill           = JFactory::getApplication()->input->get('leftFill', 'ff6600');
$rightFill          = JFactory::getApplication()->input->get('rightFill', '898E79');
...
if($save_file)
{
    $save_path =JPATH_ROOT . "/components/com_sdrsssyndicator/assets/images/buttons";
    ...
    imagepng($im, $save_path .'/'. $img_name);
